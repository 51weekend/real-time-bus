...
public class StationActivity extends BaseActivity implements
				...
				.setOnEditorActionListener(new OnEditorActionListener() {
					...
					public boolean onEditorAction(TextView v, int actionId,
						...
						if (actionId == EditorInfo.IME_ACTION_DONE) {
							String lineNumber = mStationEditText.getText()
									.toString();
							if (StringUtil.isBlank(lineNumber)) {
								TipUtil.tipDescription(StationActivity.this,
										"请输入站台名称！");
							} else {
								// TODO 查询内容
	...
	private class QueryStationFromServerTask extends
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				...
				ResultData result = DownloadData.getStation(
						StationActivity.this, URLEncoder.encode(name, "utf-8"));
				if (result.success()) {
					...
					TbStationHandler tbStationHandler = new TbStationHandler(
	...
	private class QueryStationFromLocalTask extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				...
				TbStationHandler stationHandler = new TbStationHandler(
						StationActivity.this);
