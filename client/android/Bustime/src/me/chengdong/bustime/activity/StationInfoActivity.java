...
public class StationInfoActivity extends BaseActivity implements
	...
	static final String TAG = StationInfoActivity.class.getSimpleName();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mAdapter = new StationAdapter(StationInfoActivity.this, mStationList);
	...
	public void onClick(View v) {
		...
		case R.id.searchByStationName:
			if (StringUtil.isEmpty(mStationEditText.getText().toString())) {
				Toast.makeText(StationInfoActivity.this,
						R.string.line_required, Toast.LENGTH_SHORT).show();
				break;
			}
	...
	private class QueryStationTask extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				...
				List<Station> temps = downLoadData.getStation(
						StationInfoActivity.this,
