...
public class SingleLineAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.rlStation = (RelativeLayout) convertView
					.findViewById(R.id.layout_single_line_detail);
			holder.rlCurrentStation = (RelativeLayout) convertView
					.findViewById(R.id.layout_single_line_detail_current);
			holder.tvStationName = (TextView) convertView
					.findViewById(R.id.tv_stationName);
			holder.tvCurrentStationName = (TextView) convertView
					.findViewById(R.id.tv_current_stationName);
		...
		if (StringUtil.isEmpty(singleLine.getTime())) {
			...
			holder.tvCurrentStationName.setText(singleLine.getStandName());
