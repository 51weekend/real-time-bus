...
public class TbFavoriteHandler {
    ...
    public static final String CREATE_TABLE_SQL = " CREATE TABLE " + TABLE + " (" + COLUMN_CODE + " TEXT PRIMARY KEY, "
            + COLUMN_NAME + " TEXT, " + COLUMN_PROPERTY_ONE + " TEXT, " + COLUMN_PROPERTY_TWO + " TEXT, "
    ...
    public static final String SELECT_BY_TYPE = "select * from " + TABLE + " WHERE " + COLUMN_TYPE + "=? ";
    public static final String DELETE_BY_CODE = "delete from " + TABLE + " WHERE " + COLUMN_CODE + "=? ";
    ...
    public List<Favorite> selectByType(FavoriteType favoriteType) {
        ...
        try {
            ...
            oCursor = m_oData.rawQuery(SELECT_BY_TYPE, new String[]{String.valueOf(favoriteType.getType())});
